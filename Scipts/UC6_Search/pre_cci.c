# 1 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c"
...
# 1 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c" 2
...
# 2 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c" 2
...
# 3 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c" 2
...
# 4 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c" 2

# 1 "Action.c" 1
Action()
{
	
	lr_start_transaction("UC6_Search");
	...
	lr_save_string(lr_paramarr_random("CategoriesName"),"CategoryNamernd");
	...
	web_reg_find("Text=\"categoryName\":\"{CategoryNamernd}\"","LAST");

	web_url("search", 
		"URL=https://www.advantageonlineshopping.com/catalog/api/v1/products/search?name={CategoryNamernd}&quantityPerEachCategory=10", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.advantageonlineshopping.com/", 
		"Snapshot=t71.inf", 
	...
	lr_end_transaction("UC6_Search", 2);


	return 0;
}
# 5 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c" 2
...
# 6 "c:\\users\\andrey.home-pc\\loadtestforibs\\scipts\\uc6_search\\\\combined_UC6_Search.c" 2
